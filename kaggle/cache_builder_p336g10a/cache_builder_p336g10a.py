"""Kaggle CPU kernel: HALF A of the P=336 COVERAGE cache (336 px, 10 single-slice anchors/slot).
...
Output: /kaggle/working/slots_P336_g10t1_partA/ (~14.93 GB) + the 3-study test split (part A only).
"""
import json
import os
import shutil
