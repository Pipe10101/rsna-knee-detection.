"""Kaggle CPU kernel: HALF B of the G=20 coverage cache (224 px, 20 single-slice anchors/slot).
...
Output: /kaggle/working/slots_P224_g20t1_partB/ (~11.9 GB) + the 3-study test split (part A).
"""
import json
import os
import shutil
