"""Kaggle CPU kernel: PART A of the G=10, T=3 coverage cache (224 px, 10 anchors/slot, 3-slice triplets).
...
Output: /kaggle/working/slots_P224_g10t3_partA/ (~13.3 GB) + the 3-study test split.
"""
import json
import os
import shutil
