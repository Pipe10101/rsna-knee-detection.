"""Kaggle CPU kernel: PART C of the G=10, T=3 coverage cache (224 px, 10 anchors/slot, 3-slice triplets).
...
Output: /kaggle/working/slots_P224_g10t3_partC/ (~13.3 GB).
"""
import json
import os
import shutil
...
SKIP = os.environ.get("SLOT_SKIP", "2938")
LIMIT_N = os.environ.get("SLOT_LIMIT_N", "")   # "" = to the end
PART = os.environ.get("SLOT_PART", "C")
